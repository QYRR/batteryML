...
def train_for_one_window(params, window_size):
    ...
    print(f"  [window={window_size}] Final Test MAE: {test_mae:.6f} r2: {r2:.6f}")
    ...
    return test_mae, best_params, r2
...
def main():
    ...
    for wlen in window_sizes:
        test_mae, best_params, r2 = train_for_one_window(params, wlen)
        results.append((wlen, test_mae, best_params, r2))

    # 4) Print final summary
    print("\n================ FINAL SUMMARY ================")
    print(f"Dataset: {params.dataset}")
    for (wlen, mae, bpar, r2) in results:
        print(f" - Window={wlen:2d} | Test MAE={mae:.6f} | r2={r2:.6f}| Best Params={bpar}")
    print("===============================================")
